...
const RoomInformation = ({ slice }: RoomInformationProps): JSX.Element => {
  return (
    ...
    >
      <div className="flex flex-col md:flex-row gap-5 w-full max-w-5xl mx-auto">
        <div className="flex flex-col gap-5">
          {/* Images */}
          <div className="flex flex-row h-96 gap-4">
            <PrismicNextImage
              field={slice.primary.images[0].image}
              className="w-[450px] h-96 object-cover rounded-b-2xl md:rounded-2xl"
            />
            <div className="md:flex flex-col gap-3 hidden">
              <PrismicNextImage
                field={slice.primary.images[1].image}
                className="w-full h-[calc(50%-6px)] object-cover rounded-b-2xl md:rounded-2xl"
              />
              <PrismicNextImage
        ...
        {/* Form */}
        <div className="bg-[#EBE9E9] pt-8 px-4 pb-5 rounded-2xl w-fit shadow-lg">
